function [tspan, X] = Taylor34filtFNR(fun,t0,tfin,x0,h0,hmin,hmax,abstol, reltol)
X = x0;
x = x0;
tspan = t0;
h = h0;
...
while t < tfin - h
    ...
    [xnew, errR] = Taylor34_step_1step_FNR (fun,t,h,x);
    %*****
...
hp = h;
h = tfin - t;
[x, ~] =  Taylor34_step_1step_FNR(fun,t,h,x);
t = t + h;
tspan(i) = t;
%denCond(i) = dCond;
X(:,i) = x;
